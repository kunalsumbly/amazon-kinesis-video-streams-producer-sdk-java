...
/*
 * Reference: https://github.com/sarxos/webcam-capture/tree/7e82df6ba87cdff3edfc4c8318ac0f0769db4a4a/webcam-capture-examples/webcam-capture-video-recording
 */
public class H264StreamEncoder{
	protected final Logger logger = LoggerFactory.getLogger(Logger.class);
	protected  IStreamCoder iStreamCoder = IStreamCoder.make(Direction.ENCODING, ICodec.ID.CODEC_ID_H264);
	...
	public Object encode(Object msg) throws Exception {
		...
		//here is the encode
		//convert the image
		BufferedImage convertedImage = ConverterFactory.convertToType(bufferedImage, BufferedImage.TYPE_3BYTE_BGR);
